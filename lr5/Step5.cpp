...
int main() {
    std::string inputFile = "lr5/test.txt";    // Указываем имя входного файла
    std::string outputFile = "lr5/encrypted2.txt"; // Указываем имя выходного файла
    std::string key = "mykey";               // Указываем ключ шифрования

    encryptFile(inputFile, outputFile, key);

    // Для проверки — шифруем зашифрованный файл снова
    std::string decryptedFile = "lr5/decrypted_encrypted2.txt";
